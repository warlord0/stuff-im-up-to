...
From the web GUI under navigator, select Update, click the Check Updates button and choose CD-ROM. It then showed that updates were available and I then had an Install Updates button to get the updates delivered. This is a big ISO at 1.6GB so the update is going to take a while and then a reboot of VCSA is required. ![screenshot-from-2016-10-20-145831](/blog-media/2016/10/screenshot-from-2016-10-20-145831.webp)
